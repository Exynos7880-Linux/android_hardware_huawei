...
struct PrimaryDevice : public V4_0::IPrimaryDevice {
    explicit PrimaryDevice(V2_0::IDevice* device);
    ...
    Return<void> getAudioPort(const common::V4_0::AudioPort& port, getAudioPort_cb _hidl_cb) override;
    ...
    Return<V4_0::Result> setConnectedState(const V4_0::DeviceAddress& address, bool connected) override;
